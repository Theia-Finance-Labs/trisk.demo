...
outputs_list <- trisk.datawrangle::prepare_asset_impact_data(ar_data_path = path_ar_data_raw)
...
```{r}
multi_crispy_data <- trisk.plots:::load_multiple_crispy(
...
analysis_data_bu <- trisk.plots::load_input_plots_data_from_tibble(
...
analysis_data_sector <- trisk.plots::load_input_plots_data_from_tibble(
  multi_crispy_data = multi_crispy_data,
